...
NetApp의 ONTAP 하드웨어 시스템은 올플래시, 하이브리드 플래시 및 HDD 전용 구성으로 제공되므로 성능, 용량 및 비용 요구 사항에 가장 적합한 스토리지 미디어 조합을 선택할 수 있습니다.
...
* https://www.netapp.com/pdf.html?item=/media/7828-ds-3582-aff-a-series-ai-era.pdf["AFF A-Series 데이터시트를 읽어 보십시오"^]
...
NetApp AFX는 병렬 파일 시스템과 틈새 AI 스토리지 솔루션의 모든 성능 이점을 제공하는 엔터프라이즈급 분산형 올플래시 스토리지 시스템이지만, 간단하고 안전하며 완벽하게 통합된 엔터프라이즈급 플랫폼입니다.

* https://www.netapp.com/pdf.html?item=/media/142853-ds-3466-netapp-afx-datasheet.pdf["AFX 데이터시트를 읽어보세요"^]
* https://docs.netapp.com/us-en/ontap-afx/get-started/ontap-afx-storage.html["AFX 스토리지에 대해 자세히 알아보세요"^]
...
.ASA r2 시스템
새로운 NetApp ASA r2 시스템(ASA A1K, ASA A70, ASA A90, ASA A20, ASA A30, ASA A50 및 C30)은 SAN 전용 고객의 요구 사항에 맞춰 간소화된 환경을 만드는 통합 하드웨어 및 소프트웨어 솔루션을 제공합니다.

ASA R2 시스템에서 ONTAP 소프트웨어 및 System Manager를 간소화하여 필수 SAN 기능을 지원하는 동시에 SAN 환경에서 지원되지 않는 기능에 대한 가시성을 제거합니다.

* https://www.netapp.com/pdf.html?item=/media/85736-ds-4254-asa.pdf["ASA 데이터시트를 읽어 보십시오"^]
